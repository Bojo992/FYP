...
public class ChatController : Hub
{
    ...
    public async Task PostMessage(string content)
    {
        ...
        await Clients.Others.SendAsync("ReceiveMessage", senderId, content, userMessage.SentTime, false);
        await Clients.Caller.SendAsync("ReceiveMessage", senderId, content, userMessage.SentTime, true);
    }
